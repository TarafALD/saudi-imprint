...
<head>
  ...
  <title>Dumat al-Jandal lake</title>
...
<body class="service-details-page">
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Dumat al-Jandal lake</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row align-items-center" data-aos="fade-up">
    ...
    <div class="col-md-4 text-center">
      <img src="assets/img/Guided tours/بحيره دومهه.jpg" alt="lake" class="img-fluid rounded shadow-sm" style="max-width: 100%; height: auto;">
    </div>
    ...
    <li class="list-group-item"><strong>Included:</strong>
        <ul>
        <li>Boating or Kayaking (if available)</li>
        <li>Photography Opportunities</li>
        <li>Transportation to and from the Lake</li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center">
          <!-- صورة المرشد -->
          <img src="assets/img/FakeTourGuides/TG2.png" alt="" class="img-fluid rounded-circle" style="width: 150px; height: 150px;">
        </div><br>
