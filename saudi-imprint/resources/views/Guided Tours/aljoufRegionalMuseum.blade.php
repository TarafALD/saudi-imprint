...
<head>
  ...
  <title>Aljouf Regional Museum</title>
...
<body class="service-details-page">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Over View</h1>
              <p class="mb-0">Aljouf Regional Museum is a cultural and historical landmark that showcases the rich 
                heritage of the Aljouf region in Saudi Arabia. The museum features a diverse collection of artifacts,
                 including ancient inscriptions, pottery, and tools that highlight the area's deep-rooted history. 
                 Visitors can explore exhibits that reflect the region’s traditional lifestyle, trade routes, and archaeological discoveries.
                  With interactive displays and well-preserved relics, the museum provides an immersive experience that connects visitors to Aljouf’s
                   historical and cultural significance. It stands as an important destination for those interested in Saudi Arabia’s past and heritage.</p>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Aljouf Regional Museum </li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row align-items-center" data-aos="fade-up">
    ...
    <div class="col-md-4 text-center">
      <img src="assets/img/Guided tours/متحف الجوف1.jpg" alt="Desert Safari" class="img-fluid rounded shadow-sm" style="max-width: 100%; height: auto;">
    </div>
    ...
    <li class="list-group-item"><strong>Date:</strong> july 16, 2025</li>
    <li class="list-group-item"><strong>Duration:</strong> 1 Hour</li>
    <li class="list-group-item"><strong>Group Size:</strong> Up to 15 people</li>
    <li class="list-group-item"><strong>Type of Tour:</strong> Historical & Cultural</li>
    <li class="list-group-item"><strong>Price:</strong> 80 SAR per person</li>
    <li class="list-group-item"><strong>Included:</strong>
        <ul>
        <li>Guided Museum Tour</li>
        <li>Historical Exhibits & Artifacts</li>
        <li>Cultural and Heritage Displays</li>
