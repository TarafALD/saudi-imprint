...
<body class="service-details-page">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Over View</h1>
              <p class="mb-0">AlUla Old Town is a fascinating historic site in the heart of AlUla, 
                showcasing ancient mud-brick houses and narrow alleys that reflect the region's rich heritage. 
                It offers a glimpse into the past with its well-preserved architecture and vibrant history, 
                making it a must-visit for those interested in exploring Saudi Arabia's cultural roots.</p>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">AlUla Old Town</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row align-items-center" data-aos="fade-up">
    <div class="col-md-4 text-center">
      <img src="assets/img/Guided tours/AlUla Old Town.jpg" alt="Desert Safari" class="img-fluid rounded shadow-sm" style="max-width: 100%; height: auto;">
    </div>
    <div class="col-md-8">
      <h2>Tour Details : </h2>
    ...
    <li class="list-group-item"><strong>Type of Tour:</strong>Historical Exploration</li>
    <li class="list-group-item"><strong>Price:</strong> 70 SAR per person</li>
    <li class="list-group-item"><strong>Included:</strong>
        <ul>
        <li>Guided Tour with a Local Expert</li>
        <li>Free Bus Transportation</li>    
        <li>Exploration of AlUla Old Town’s Historic Streets</li>  
        <li>Visit to the Ancient Ruins and Heritage Sites</li>  
        <li>Learn About the Traditional Architecture and Culture</li>  
        <li>Photo Opportunities at Iconic Landmarks</li>  
  </ul>
</li>
