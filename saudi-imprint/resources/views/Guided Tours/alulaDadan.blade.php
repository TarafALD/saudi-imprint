...
<head>
  ...
  <title>Dadan and Jabal Ikmah</title>
...
<body class="service-details-page">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Over View</h1>
              <p class="mb-0">Dadan and Jabal Ikmah in AlUla are remarkable archaeological sites showcasing
                 the rich history of ancient Arabian civilizations. Dadan was the capital of the Dadanite and Lihyanite 
                 kingdoms, while Jabal Ikmah is an open-air library featuring thousands of inscriptions, offering a glimpse 
                 into the region’s cultural and linguistic heritage.</p>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Dadan and Jabal Ikmah</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row align-items-center" data-aos="fade-up">
    <div class="col-md-4 text-center">
      <img src="assets/img/Guided tours/Dadan and Jabal Ikmah2.jpg" alt="Desert Safari" class="img-fluid rounded shadow-sm" style="max-width: 100%; height: auto;">
    </div>
    <div class="col-md-8">
      <h2>Tour Details : </h2>
    ...
    <li class="list-group-item"><strong>Included:</strong>
        <ul>
        <li>Guided Tour with a Professional Archaeology Expert</li>    
        <li>Scenic Drive through AlUla’s Historic Sites</li>  
        <li>Exploration of the Ancient City of Dadan</li>  
        <li>Visit to Jabal Ikmah, the Open-Air Library of AlUla</li>  
        <li>Photo Stops at Iconic Inscriptions and Landmarks</li>  
