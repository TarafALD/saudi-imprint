...
<body class="service-details-page">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Over View</h1>
              <p class="mb-0">Escape the city's hustle and immerse yourself in the breathtaking landscapes of the Riyadh desert 
                on this one-hour guided hike. Traverse golden dunes and rocky trails as you witness the stunning contrast between 
                vast open spaces and rugged terrain. Along the way, learn about the region’s unique geology, native wildlife, and rich Bedouin heritage. 
                Whether you're a nature enthusiast or just seeking a refreshing outdoor adventure, this short yet unforgettable journey promises scenic views,
                 fresh desert air, and a true taste of Saudi Arabia’s natural beauty.</p>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Hike In The Riyadh Desert </li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row align-items-center" data-aos="fade-up">
    ...
    <div class="col-md-8">
      ...
      <li class="list-group-item"><strong>Date:</strong> Available Daily</li>
    ...
    <li class="list-group-item"><strong>Type of Tour:</strong> Hiking & Nature Exploration</li>
