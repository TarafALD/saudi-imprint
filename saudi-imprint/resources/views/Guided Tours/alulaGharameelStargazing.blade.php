...
<head>
  ...
  <title>Gharameel Stargazing</title>
...
<body class="service-details-page">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Over View</h1>
              <p class="mb-0">Gharameel Stargazing in AlUla offers a mesmerizing experience under 
                some of the clearest night skies in Saudi Arabia. Located in a remote desert landscape, 
                the area is famous for its unique rock formations that create a dramatic backdrop for stargazing. 
                With minimal light pollution, visitors can enjoy breathtaking views of the Milky Way and countless stars, 
                making it a perfect spot for astronomy enthusiasts and nature lovers. Guided tours often include storytelling,
                 astronomy insights, and traditional Bedouin hospitality, enhancing the magical experience.</p>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Gharameel Stargazing </li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row align-items-center" data-aos="fade-up">
    <div class="col-md-4 text-center">
      <img src="assets/img/Guided tours/Gharameel Stargazing.jpg" alt="Desert Safari" class="img-fluid rounded shadow-sm" style="max-width: 100%; height: auto;">
    </div>
    <div class="col-md-8">
      <h2>Tour Details : </h2>
    ...
    <li class="list-group-item"><strong>Type of Tour:</strong>Camping & Nature Exploration</li>
    <li class="list-group-item"><strong>Price:</strong> 100 SAR per person</li>
    <li class="list-group-item"><strong>Included:</strong>
        <ul>
        <li>Professional Stargazing Guide</li>
        <li>Scenic Desert Trails</li>
        <li>High-Powered Telescopes for Stargazing</li>
        <li>Astronomy Insights & Mythology Stories</li>
        <li>Photo Stops at Iconic Landmarks</li>
        <li>Refreshments (Water & Snacks)</li>
  </ul>
</li>
