...
<head>
  ...
  <title>Sheikh Fahd Al-Buliehd Museum</title>
...
<body class="service-details-page">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Over View</h1>
              <p class="mb-0">Sheikh Fahd Al-Buliehd Museum in Al-Jouf is a private museum showcasing
                 a rich collection of historical artifacts, antiques, and cultural heritage items that reflect the region's history.</p>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Sheikh Fahd Al-Buliehd Museum </li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row align-items-center" data-aos="fade-up">
    ...
    <div class="col-md-4 text-center">
      <img src="assets/img/Guided tours/متحف الشيخ فهد.jpg" alt="" class="img-fluid rounded shadow-sm" style="max-width: 100%; height: auto;">
    </div>
    ...
    <li class="list-group-item"><strong>Date:</strong> May 17, 2025</li>
    ...
    <li class="list-group-item"><strong>Price:</strong> 50 SAR per person</li>
    <li class="list-group-item"><strong>Included:</strong>
        <ul>
        <li>Guided Museum Tour</li>
        <li>Collection of Local Antiques & Artifacts</li>
        <li>Insight into Traditional Saudi Lifestyle</li>
        <li>Personal Stories & Historical Narratives</li>
