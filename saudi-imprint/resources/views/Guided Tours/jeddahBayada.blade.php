...
<head>
  ...
  <title>Boat Tour In Bayada</title>
...
<body class="service-details-page">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Over View</h1>
              <p class="mb-0">The Boat Tour in Bayada offers a unique opportunity to explore the stunning
                 coastline of the region. Visitors can enjoy breathtaking views of the turquoise waters,
                  rocky cliffs, and hidden caves while cruising on a comfortable boat. This peaceful journey 
                  is perfect for nature lovers and those seeking a tranquil escape surrounded by natural beauty.</p>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Boat Tour In Bayada</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row align-items-center" data-aos="fade-up">
    <div class="col-md-4 text-center">
      <img src="assets/img/Guided tours/Boat Tour In Bayada2.jpg" alt="Desert Safari" class="img-fluid rounded shadow-sm" style="max-width: 100%; height: auto;">
    </div>
    <div class="col-md-8">
      <h2>Tour Details : </h2>
    ...
    <li class="list-group-item"><strong>Group Size:</strong> Up to 12 people</li>
    <li class="list-group-item"><strong>Type of Tour:</strong>Boat Cruise Experience</li>
    <li class="list-group-item"><strong>Price:</strong> 250 SAR per person</li>
    <li class="list-group-item"><strong>Included:</strong>
        <ul>
        <li>Guided Boat Tour with a Local Expert</li>
        <li>Exploration of Bayada’s Coastal Views</li>
