...
<body class="index-page">
  ...
  <main class="main">
    ...
    <div class="row gy-4 align-items-center">
      <div class="col-md-6 order-2 order-md-1 d-flex flex-column justify-content-center">
            <h2>Elephant Rock</h2>
            <p>Elephant Rock, also known as Jabal AlFil, is one of AlUla’s most iconic natural landmarks.
                 This massive rock formation, shaped like an elephant, stands majestically in the desert,
                  offering breathtaking views, especially at sunset.</p>
          </div>
  ...
  <li><i class="bi bi-clock"></i> <span style="font-weight: bold; font-size: 16.5px; margin-left: 5px;">Opening Hours :</span>
    <ul style="list-style-type: circle;">
    <li>Sunday to Thursday: 4:00 PM - 12:00 AM</li>
    <li>Friday to Saturday: 4:00 PM - 2:00 AM</li>
    </ul>
  </li>
</ul>
</div> 
        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/img/ThingsToDoAlula/jabal-alfil-in-alula.jpg" class="d-block w-100" alt="صورة 1">
            </div>
            <div class="carousel-item">
              <img src="assets/img/ThingsToDoAlula/jabal-alfil-in-alula-article.jpg" class="d-block w-100" alt="صورة 2">
            </div>
          </div>
    ...
    <iframe 
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3623.312084257451!2d37.981500!3d26.689361!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjbCsDQxJzIxLjciTiAzN8KwNTgnNTMuNCJF!5e0!3m2!1sen!2ssa!4v1710000000000"  
      width="100%" 
      height="350" 
...
<br>
  ...
  <div class="text-center mt-3">
    <a href="https://www.google.com/maps/dir/?api=1&destination=26.689361,37.981500" target="_blank" class="btn btn-primary" style="width: 200px;">
      Get Directions
    </a>
  </div>
</div>
