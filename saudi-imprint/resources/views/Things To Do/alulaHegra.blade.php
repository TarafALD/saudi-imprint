...
<body class="index-page">
  ...
  <main class="main">
    ...
    <div class="row gy-4 align-items-center">
      <div class="col-md-6 order-2 order-md-1 d-flex flex-column justify-content-center">
            <h2>Hegra</h2>
            <p>Hegra, also known as Al-Hijr or Mada’in Salih, is a UNESCO World Heritage Site in AlUla, 
        Saudi Arabia. It features over 100 well-preserved Nabataean tombs carved into sandstone cliffs,
        showcasing intricate inscriptions and stunning ancient architecture. As the southern capital of the Nabataean Kingdom, 
        Hegra offers a glimpse into the rich history and culture of this ancient civilization.</p>
          </div>
  ...
  <li><i class="bi bi-clock"></i> <span style="font-weight: bold; font-size: 16.5px; margin-left: 5px;">Opening Hours :</span>
        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/img/ThingsToDoAlula/hegra1.jpg" class="d-block w-100" alt="صورة 1">
            </div>
            <div class="carousel-item">
              <img src="assets/img/ThingsToDoAlula/hegra2.jpg" class="d-block w-100" alt="صورة 2">
            </div>
            <div class="carousel-item">
              <img src="assets/img/ThingsToDoAlula/hegra3.jpg" class="d-block w-100" alt="صورة 3">
            </div>
          </div>
    ...
    <iframe 
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3623.312084257451!2d37.957889!3d26.804333!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjbCsDQ4JzE1LjYiTiAzN8KwNTcnMjguNCJF!5e0!3m2!1sen!2ssa!4v1710000000000"  
      width="100%" 
      height="350" 
...
<br>
  ...
  <div class="text-center mt-3">
    <a href="https://www.google.com/maps/dir/?api=1&destination=26.804333,37.957889" target="_blank" class="btn btn-primary" style="width: 200px;">
      Get Directions
    </a>
  </div>
</div>
