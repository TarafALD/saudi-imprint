...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\aldri\saudi-imprint\saudi-imprint\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\aldri\\saudi-imprint\\saudi-imprint\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'adminlte.darkmode.toggle','register','signupTG',
'signupT','loginTG',
...
'logout','home','dashboard','login','TourGuide.pending_approval',
'TourGuide.rejected','TourGuide.complete_profile','TourGuide.save_profile','TourGuide.dashboard','add_tour',
'TourGuide.updateProfile','profile.edit','profile.update','profile.destroy','Admin.dashboard',
'admin.tour-guides.approve','admin.tour-guides.reject','registerTG','riyadh','aljouf',
'alula','jeddah','tours.store','tours.edit','tours.update',
'tours.destroy','bookings.create','bookings.store','bookings.show','bookings.index',
'bookings.destroy','home','tours.index','tours.show',
'riyadhDesertSafari','riyadhCampingAdventure','riyadhHike','UmAlheshLake','riyadhSouqTaibah',
'riyadhRawdatTinhat','riyadhAlSubaiePalace','riyadhVia','Guided Tours.jeddahBayada','Guided Tours.jeddahDivingAdventure',
'Guided Tours.jeddahHistoricJeddah','Guided Tours.jeddahFishing','jeddahArabMall','jeddahSeafront','jeddahHistoric',
'Guided Tours.aljoufRegionalMuseum','Guided Tours.aljoufZabalCastle','Guided Tours.aljoufFahdMuseum','Guided Tours.aljoufLake','aljoufCitiesMall',
'aljoufMountainPark','aljoufMosque','aljoufMaridCastle','Guided Tours.alulaGharameelStargazing','Guided Tours.alulaElephantRock',
'Guided Tours.alulaDadan','Guided Tours.alulaOldTown','alulaAlJadidahArts','alulaElephantRock','alulaHegra',
'storage.local',);
        registerArgumentsSet('views', 
'Admin.dashboard','Destinations.aljouf','Destinations.alula','Destinations.jeddah','Destinations.riyadh',
'Guided Tours.UmAlheshLake','Guided Tours.aljoufFahdMuseum','Guided Tours.aljoufLake','Guided Tours.aljoufRegionalMuseum','Guided Tours.aljoufZabalCastle',
'Guided Tours.alulaDadan','Guided Tours.alulaElephantRock','Guided Tours.alulaGharameelStargazing','Guided Tours.alulaOldTown','Guided Tours.index',
'Guided Tours.jeddahBayada','Guided Tours.jeddahDivingAdventure','Guided Tours.jeddahFishing','Guided Tours.jeddahHistoricJeddah','Guided Tours.riyadhCampingAdventure',
'Guided Tours.riyadhDesertSafari','Guided Tours.riyadhHike','Guided Tours.show','Things To Do.JeddahSeafront','Things To Do.aljoufCitiesMall',
'Things To Do.aljoufMaridCastle','Things To Do.aljoufMosque','Things To Do.aljoufMountainPark','Things To Do.alulaAlJadidahArts','Things To Do.alulaElephantRock',
'Things To Do.alulaHegra','Things To Do.jeddahArabMall','Things To Do.jeddahHistoric','Things To Do.riyadhAlSubaiePalace','Things To Do.riyadhRawdatTinhat',
'Things To Do.riyadhSouqTaibah','Things To Do.riyadhVia','TourGuide.add_tour','TourGuide.complete_profile','TourGuide.dashboard',
'TourGuide.pending_approval','TourGuide.rejected','auth.confirm-password','auth.forgot-password','auth.loginTG',
'auth.reset-password','auth.signupT','auth.signupTG','auth.verify-email','bookings.confirmation',
'bookings.create','components.application-logo','components.auth-session-status','components.danger-button','components.dropdown',
...
'dbconn','layouts.app','layouts.guest','layouts.navigation','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','tourist.TouristPage','welcome',
...
'adminlte.0','iframe.0','menu.0','adminlte::adminlte.full_name','adminlte::adminlte.email',
'adminlte::adminlte.password','adminlte::adminlte.retype_password','adminlte::adminlte.remember_me','adminlte::adminlte.register','adminlte::adminlte.register_a_new_membership',
'adminlte::adminlte.i_forgot_my_password','adminlte::adminlte.i_already_have_a_membership','adminlte::adminlte.sign_in','adminlte::adminlte.log_out','adminlte::adminlte.toggle_navigation',
'adminlte::adminlte.login_message','adminlte::adminlte.register_message','adminlte::adminlte.password_reset_message','adminlte::adminlte.reset_password','adminlte::adminlte.send_password_reset_link',
'adminlte::adminlte.verify_message','adminlte::adminlte.verify_email_sent','adminlte::adminlte.verify_check_your_email','adminlte::adminlte.verify_if_not_recieved','adminlte::adminlte.verify_request_another',
'adminlte::adminlte.confirm_password_message','adminlte::adminlte.remember_me_hint','adminlte::iframe.btn_close','adminlte::iframe.btn_close_active','adminlte::iframe.btn_close_all',
'adminlte::iframe.btn_close_all_other','adminlte::iframe.tab_empty','adminlte::iframe.tab_home','adminlte::iframe.tab_loading','adminlte::menu.main_navigation',
'adminlte::menu.blog','adminlte::menu.pages','adminlte::menu.account_settings','adminlte::menu.profile','adminlte::menu.change_password',
'adminlte::menu.multilevel','adminlte::menu.level_one','adminlte::menu.level_two','adminlte::menu.level_three','adminlte::menu.labels',
'adminlte::menu.important','adminlte::menu.warning','adminlte::menu.information',);
